...
class MPR121:
    ...
    def reset(self) -> None:
        ...
        for i in range(12):
            self._write_register_byte(MPR121_TOUCHTH_0 + 2 * i, 120)#
            self._write_register_byte(MPR121_RELEASETH_0 + 2 * i, 100)#

        # Configure baseline filtering control registers.
        self._write_register_byte(MPR121_MHDR, 0x01)
        self._write_register_byte(MPR121_NHDR, 0x0A)#0 to 63
        self._write_register_byte(MPR121_NCLR, 0x05)#
        self._write_register_byte(MPR121_FDLR, 0x00)
        self._write_register_byte(MPR121_MHDF, 1)#1 : 0 to 63
        self._write_register_byte(MPR121_NHDF, 15)#0x0f: 0 to 63
        self._write_register_byte(MPR121_NCLF, 50)#8 : 0 to 255
        ...
        self._write_register_byte(MPR121_DEBOUNCE, 0x33)
